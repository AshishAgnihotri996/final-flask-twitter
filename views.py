...
def register():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('profile')) #directly return to profile page from regitster --> profile

    return render_template('register.html', form=form) #registration form
